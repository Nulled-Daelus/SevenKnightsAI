...
namespace SevenKnightsAI
{
    public partial class MainForm : Form
    {
        ...
        private void AD_difficultyComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox comboBox = sender as ComboBox;
            this.AISettings.AD_Difficulty = (Difficulty)comboBox.SelectedIndex;
        }
        ...
        private void AD_worldComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (this.AISettings.AD_World == World.WesternEmperorsLand)
            {
                this.AD_PopulateStage(15);
            }
            /*else if (this.AISettings.AD_World == World.SagePeak)  //new patch already at 10
            {
        ...
        private void InitAdventureTab()
        {
            ...
            this.AD_difficultyComboBox.SelectedIndex = (int)this.AISettings.AD_Difficulty;
