                                    ...
                                    switch (scene.SceneType)
                                    {
                                        ...
                                        case SceneType.MAP_SELECT:
                                            ...
                                            else if (this.CurrentObjective == Objective.ADVENTURE)
                                            {
                                                ...
                                                if (world == World.MoonlitIsle || world == World.WesternEmperorsLand || world == World.SagePeak)
                                                {
                                                    if (!this.MatchMapping(MapSelectPM.AsgarContinentShipMiddle, 2) && !this.MatchMapping(MapSelectPM.AsgarContinentShipMiddle, 2))
                                                    {
