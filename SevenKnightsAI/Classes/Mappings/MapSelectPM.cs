namespace SevenKnightsAI.Classes.Mappings
{
    internal static class MapSelectPM
    {
        ...
        public static readonly PixelMapping ContinentButton = new PixelMapping
        {
            X = 910,
            Y = 490,
            Color = 0,
        ...
        public static readonly PixelMapping DifficultyBoxBorderLeft = new PixelMapping
        {
            X = 25,
            Y = 498,
            Color = 4006419,
        ...
        public static readonly PixelMapping DifficultyBoxBorderRight = new PixelMapping
        {
            X = 149,
            Y = 498,
            Color = 4006419,
        ...
        public static readonly PixelMapping QuickStartIcon = new PixelMapping
        {
            X = 834,
            Y = 466,
            Color = 3745302,
        ...
        public static readonly PixelMapping AsgarContinentShipMiddle = new PixelMapping
        {
            X = 907,
            Y = 491,
            Color = 15388835,
        ...
        public static readonly PixelMapping AsgarContinentShipRight = new PixelMapping
        {
            X = 930,
            Y = 491,
            Color = 14598539,
