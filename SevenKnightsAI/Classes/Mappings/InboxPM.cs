namespace SevenKnightsAI.Classes.Mappings
{
    internal static class InboxPM
    {
        ...
        public static readonly PixelMapping GoldTabRedIcon = new PixelMapping
        {
            X = 577,
            Y = 112,
            Color = 13641728,
        ...
        public static readonly PixelMapping RubiesTab = new PixelMapping
        {
            X = 765,
            Y = 135,
            Color = 0,
        ...
        public static readonly PixelMapping RubiesTabRedIcon = new PixelMapping
        {
            X = 704,
            Y = 112,
            Color = 13576448,
